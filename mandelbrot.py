...
def createMandelbrot(array,centre,zoom,cutoff):
...
imageArray = createMandelbrot(imageArray,centre,zoom,cutoff)
imageArray = createColours(imageArray)
drawMandelbrot(imageArray,img)

#img.write("img/mandelbrot/" + str(centre[0]) + " + " + str(centre[1]) + "i zoom=" + str(zoom) + ".gif",format="gif")
